...
//     try {
//       const response = await getPendingRentRequestsAdmin();
//       console.log("Admin API response:", response); // already contains { message, data }
//       setPendingRequests(response.data || []);
//     } catch (error) {
...
//               <tr key={request._id}>
//                 <td>{request._id}</td>
//                 <td>{request.userId?.firstName || "N/A"} {request.userId?.lastName || ""}</td>
...
//                     variant="success"
//                     className="me-2"
//                     disabled={!request.bicycleId} // cannot approve if bicycle is null
